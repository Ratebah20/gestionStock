// Fichier d'exportation pour les composants de formation
export { default as FormationEncoding } from './formation-encoding';
export { default as FormationPlanning } from './formation-planning';
